...
method=stl            # (splines,stl) which input to use, either splines = use "biceps_splines.stl" or stl = use "biceps.surface.pickle"
...
mpirun -n $nproc --oversubscribe ./generate ../settings_generate2.py \
