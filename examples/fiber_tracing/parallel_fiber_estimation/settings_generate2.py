...
if args["input_filename_or_splines_or_stl"] == "splines":
  ...
  input_mesh_filename = "../biceps_full.stl"
else:
...
config = {
  ...
  "ParallelFiberEstimation" : {
    ...
    "OutputWriter": [
      {"format": "Paraview", "outputInterval": 1, "filename": "out/biceps", "ascii": True, "fixedFormat": False, "combineFiles": False, "fileNumbering": "incremental"},
    ]
  }
}
