...
scenario_name = "g-3_B_death_75"

Conductivity = 3.828      # [mS/cm] sigma, conductivity

generated_input_directory = os.environ.get(
    "OPENDIHU_GENERATED_MU_DIR",
    r"/mnt/pixstor/data/maoy/opendihu/opendihu/examples/electrophysiology/fibers/fibers_fat_emg/fiber_dist_generator/opendihu_repeated_denervation_study/g-3/protocol_B/death_75"
)
