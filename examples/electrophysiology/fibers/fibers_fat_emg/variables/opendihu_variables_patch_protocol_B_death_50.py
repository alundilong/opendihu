...
generated_input_directory = os.environ.get(
    ...
    r"/home/ymaom/workspace/opendihu/examples/electrophysiology/fibers/fibers_fat_emg/opendihu_distribution_generator/protocol_B_compensated_drive/death_50"
)
