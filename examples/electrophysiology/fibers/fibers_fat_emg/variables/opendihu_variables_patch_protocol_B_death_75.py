...
generated_input_directory = os.environ.get(
    ...
    r"/home/ymaom/workspace/opendihu/examples/electrophysiology/input/opendihu_distribution_generator_v2_case_package/protocol_B_compensated_drive/death_75"
)
