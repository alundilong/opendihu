...
scenario_name = "healthy2"

Conductivity = 3.828      # [mS/cm] sigma, conductivity

generated_input_directory = os.environ.get(
    "OPENDIHU_GENERATED_MU_DIR",
    r"/home/ymaom/workspace/opendihu/examples/electrophysiology/input/opendihu_distribution_generator_v2_case_package/aging_type2_emg/healthy"
)
...
def get_specific_states_call_enable_begin(fiber_no, mu_no):
  return _mu(mu_no)["activation_start_time"]*0
