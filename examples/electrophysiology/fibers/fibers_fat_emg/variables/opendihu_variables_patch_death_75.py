...
scenario_name = "death_75"

Conductivity = 3.828      # [mS/cm] sigma, conductivity

generated_input_directory = os.environ.get(
    "OPENDIHU_GENERATED_MU_DIR",
    r"/home/maoy/data/opendihu/opendihu/examples/electrophysiology/fibers/fibers_fat_emg/opendihu_distribution_generator/opendihu_mu_case_package/death_75"
)
