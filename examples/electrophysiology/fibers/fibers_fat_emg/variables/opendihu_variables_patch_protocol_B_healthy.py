...
scenario_name = "healthy_protocol_B"
...
generated_input_directory = os.environ.get(
    ...
    r"/home/maoy/data/opendihu/opendihu/examples/electrophysiology/fibers/fibers_fat_emg/opendihu_distribution_generator/protocol_B_compensated_drive/healthy"
)
