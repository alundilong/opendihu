...
generated_input_directory = os.environ.get(
    ...
    r"/home/ymaom/workspace/opendihu/examples/electrophysiology/input/opendihu_distribution_generator_v2_case_package/opendihu_mu_case_package_fixed/death_50"
)
