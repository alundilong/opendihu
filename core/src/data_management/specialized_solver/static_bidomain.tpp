...
StaticBidomain<FunctionSpaceType>::StaticBidomain(DihuContext context)
    : Data<FunctionSpaceType>::Data(context) {}

template <typename FunctionSpaceType>
void StaticBidomain<FunctionSpaceType>::initialize() {
...
StaticBidomain<FunctionSpaceType>::fiberDirection() {
  return this->fiberDirection_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::flowPotential() {
  return this->flowPotential_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::extraCellularPotential() {
  return this->extraCellularPotential_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::transmembranePotential() {
  return this->transmembranePotential_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::transmembraneFlow() {
  return this->transmembraneFlow_;
}

template <typename FunctionSpaceType>
Mat &StaticBidomain<FunctionSpaceType>::rhsMatrix() {
  return this->rhsMatrix_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::zero() {
  return this->zero_;
}

template <typename FunctionSpaceType>
std::shared_ptr<FieldVariable::FieldVariable<FunctionSpaceType, 1>>
StaticBidomain<FunctionSpaceType>::jacobianConditionNumber() {
...
template <typename FunctionSpaceType>
std::shared_ptr<
    typename StaticBidomain<FunctionSpaceType>::SlotConnectorDataType>
StaticBidomain<FunctionSpaceType>::getSlotConnectorData() {
